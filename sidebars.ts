    ...
    },
    {
      ...
      items: [
        'cli/cli-overview',
        {
          ...
          collapsed: false,
          items: [
            'cli/commands/cli-contacts',
            'cli/commands/cli-messaging',
            'cli/commands/cli-voice',
            'cli/commands/cli-video',
            'cli/commands/cli-ai',
            'cli/commands/cli-objects',
            'cli/commands/cli-tasks',
            'cli/commands/cli-workflows',
            'cli/commands/cli-platform',
            'cli/commands/cli-admin',
          ],
        },
      ],
    },
